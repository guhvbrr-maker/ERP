-- ============================================================================
-- COMPLETAR MÓDULO DE PRODUTOS - Tabelas e Policies
-- ============================================================================

-- Tabelas (IF NOT EXISTS funciona aqui)
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE table_name = 'stocks' AND column_name = 'available'
  ) THEN
...
-- Drop e recriar policies (approach seguro)
DO $$ BEGIN
